...
template<Peripheral p> struct SignalConnection<DataF0::A0, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF0::A0 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF0::A0, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF1::A1, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF1::A1 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF1::A1, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF2::A2, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF2::A2 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF2::A2, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF3::A3, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF3::A3 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF3::A3, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF4::A4, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF4::A4 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF4::A4, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF5::A5, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF5::A5 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF5::A5, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF6::Niord, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF6::Niord only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF6::Niord, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF7::Nreg, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF7::Nreg only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF7::Nreg, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF8::Niowr, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF8::Niowr only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF8::Niowr, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF9::Cd, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF9::Cd only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF9::Cd, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF10::Intr, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF10::Intr only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataF10::Intr, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF12::A6, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF12::A6 only connects to Fsmc!"); };
template<> struct SignalConnection<DataF12::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataF12::A6, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF13::A7, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF13::A7 only connects to Fsmc!"); };
template<> struct SignalConnection<DataF13::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataF13::A7, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF14::A8, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF14::A8 only connects to Fsmc!"); };
template<> struct SignalConnection<DataF14::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataF14::A8, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataF15::A9, p> {
	static_assert((p == Peripheral::Fsmc),"GpioF15::A9 only connects to Fsmc!"); };
template<> struct SignalConnection<DataF15::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataF15::A9, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG0::A10, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG0::A10 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG0::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG0::A10, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG1::A11, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG1::A11 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG1::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG1::A11, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG2::A12, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG2::A12 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG2::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG2::A12, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG3::A13, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG3::A13 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG3::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG3::A13, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG4::A14, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG4::A14 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG4::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG4::A14, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG5::A15, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG5::A15 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG5::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG5::A15, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG6::Int2, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG6::Int2 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG6::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG6::Int2, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG7::Int3, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG7::Int3 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataG7::Int3, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG9::Nce3, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG9::Nce3 only connects to Fsmc!"); };
template<Peripheral p> struct SignalConnection<DataG9::Ne2, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG9::Ne2 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataG9::Nce3, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
template<> struct SignalConnection<DataG9::Ne2, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG10::Nce41, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG10::Nce41 only connects to Fsmc!"); };
template<Peripheral p> struct SignalConnection<DataG10::Ne3, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG10::Ne3 only connects to Fsmc!"); };
template<> struct SignalConnection<DataG10::BitBang, Peripheral::BitBang> { static constexpr int8_t af = -1; };
template<> struct SignalConnection<DataG10::Nce41, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
template<> struct SignalConnection<DataG10::Ne3, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG11::Nce42, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG11::Nce42 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataG11::Nce42, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG12::Ne4, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG12::Ne4 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataG12::Ne4, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG13::A24, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG13::A24 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataG13::A24, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<Peripheral p> struct SignalConnection<DataG14::A25, p> {
	static_assert((p == Peripheral::Fsmc),"GpioG14::A25 only connects to Fsmc!"); };
...
template<> struct SignalConnection<DataG14::A25, Peripheral::Fsmc> { static constexpr int8_t af = 12; };
...
template<> struct SignalConnection<DataI8::Af2, Peripheral::Rtc> { static constexpr int8_t af = 0; };
