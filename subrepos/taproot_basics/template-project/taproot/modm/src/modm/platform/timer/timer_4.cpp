...
bool
modm::platform::Timer4::isEnabled()
{
	return Rcc::isEnabled<Peripheral::Tim4>();
}
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer4::configureInputChannel(uint32_t channel, uint8_t filter) {
		channel -= 1;	// 1..4 -> 0..3
