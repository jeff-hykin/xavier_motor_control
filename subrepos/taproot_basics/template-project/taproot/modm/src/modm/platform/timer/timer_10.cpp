...
bool
modm::platform::Timer10::isEnabled()
{
	return Rcc::isEnabled<Peripheral::Tim10>();
}
...
// ----------------------------------------------------------------------------
void
modm::platform::Timer10::configureInputChannel(uint32_t channel, uint8_t filter) {
		channel -= 1;	// 1..4 -> 0..3
